...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    obstaclesGroup.setVelocityXEach(-distance/60);
    shrubsGroup.setVelocityXEach(-distance/60);
  ...
  if(score >= 5){
    ...
    stroke(3);
    fill("black");
    text("Congragulations!! You win the game!! ", camera.position.x-250,200);
    gameState = WIN;
  }
}
...
function spawnObstacles() {
  if(frameCount % 200 === 0) {
    ...
    // obstacle.velocityX = -distance/60;
    obstacle.scale = 0.15;      
